...
#define Z_MULTI_STEPPER_DRIVERS ANY(Z_DUAL_STEPPER_DRIVERS, Z_TRIPLE_STEPPER_DRIVERS, Z_QUAD_STEPPER_DRIVERS)
#define Z_MULTI_ENDSTOPS        ANY(Z_DUAL_ENDSTOPS, Z_TRIPLE_ENDSTOPS, Z_QUAD_ENDSTOPS)
